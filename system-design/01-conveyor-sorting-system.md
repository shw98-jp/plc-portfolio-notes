...
<div class="system-diagram" aria-label="Conveyor sorting system layout">
  <div class="diagram-direction">製品の移動方向 →</div>
  <div class="diagram-sensors">
    <div class="diagram-node">金属検出センサ <strong>X3</strong></div>
    <div class="diagram-line" aria-hidden="true"></div>
    <div class="diagram-node">仕分け位置センサ <strong>X4</strong></div>
  </div>
  <div class="diagram-stop">コンベヤ停止</div>
